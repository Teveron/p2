...
CREATE TABLE Bellini.Course (
    ...
    CoursePrefix      NVARCHAR(10) NOT NULL,   -- CIS, COP, MAC ...
    CourseNumber      NVARCHAR(10) NOT NULL,            -- 2510, 3515, 4622L ...
    CourseTitle       NVARCHAR(200) NOT NULL,
    Credits           INT NOT NULL,
    CourseDescription NVARCHAR(MAX) NULL,
    CourseLevel       INT NOT NULL,            -- 2000, 3000, 4000
...
------------------------------------------------------------
-- Course Requirements (Core + State Mandated)
------------------------------------------------------------
-- BSCS core
INSERT INTO Bellini.CourseRequirement (MajorID, CourseID, CatalogID, RequirementType, MinGradeRequired)
VALUES
    (@MAJOR_BSCS, @COP2510_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSCS, @COP3515_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSCS, @CIS3250_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSCS, @CIS4250_ID, @CATALOG_2023_2024, 'Core', 'C');

-- BSCP core
INSERT INTO Bellini.CourseRequirement (MajorID, CourseID, CatalogID, RequirementType, MinGradeRequired)
VALUES
    (@MAJOR_BSCP, @COP2510_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSCP, @COP3515_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSCP, @MAC2281_ID, @CATALOG_2023_2024, 'Core', 'C');

-- BSIT core
INSERT INTO Bellini.CourseRequirement (MajorID, CourseID, CatalogID, RequirementType, MinGradeRequired)
VALUES
    (@MAJOR_BSIT, @COP2510_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSIT, @CIS3250_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSIT, @CGS2100_ID, @CATALOG_2023_2024, 'Core', 'C');

-- BSCyS core
INSERT INTO Bellini.CourseRequirement (MajorID, CourseID, CatalogID, RequirementType, MinGradeRequired)
VALUES
    (@MAJOR_BSCyS, @COP2510_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSCyS, @CNT4104_ID, @CATALOG_2023_2024, 'Core', 'C'),
    (@MAJOR_BSCyS, @CIS4622_ID, @CATALOG_2023_2024, 'Core', 'C');

-- State-mandated example
INSERT INTO Bellini.CourseRequirement (MajorID, CourseID, CatalogID, RequirementType, MinGradeRequired)
VALUES
    (@MAJOR_BSCS,  @ECO2013_ID, @CATALOG_2023_2024, 'StateMandated', 'C'),
    (@MAJOR_BSCP,  @ECO2013_ID, @CATALOG_2023_2024, 'StateMandated', 'C'),
    (@MAJOR_BSIT,  @ECO2013_ID, @CATALOG_2023_2024, 'StateMandated', 'C'),
    (@MAJOR_BSCyS, @ECO2013_ID, @CATALOG_2023_2024, 'StateMandated', 'C');


------------------------------------------------------------
-- RequirementGroup: BSCS Calc I (MAC 2281 OR MAC 2311)
------------------------------------------------------------
INSERT INTO Bellini.RequirementGroup (MajorID, CatalogID, GroupCode, GroupName, MinCoursesRequired)
VALUES
    (@MAJOR_BSCS, @CATALOG_2023_2024, 'BSCS23_CALC1', 'BSCS Calculus I Requirement', 1);

SELECT @CalcGroupID = RequirementGroupID FROM Bellini.RequirementGroup WHERE MajorID=@MAJOR_BSCS AND GroupCode='BSCS23_CALC1';
...
VALUES
    (@CalcGroupID, @MAC2281_ID),
    (@CalcGroupID, @MAC2311_ID);

------------------------------------------------------------
-- Course Prereqs
------------------------------------------------------------

-- COP3515 requires COP2510
INSERT INTO Bellini.CoursePrereq (CourseID, PrereqCourseID, MinGradeRequired)
VALUES
    (@COP3515_ID, @COP2510_ID, 'C');

-- CNT4104 and CIS4622 require COP2510
INSERT INTO Bellini.CoursePrereq (CourseID, PrereqCourseID, MinGradeRequired)
VALUES
    (@CNT4104_ID, @COP2510_ID, 'C'),
    (@CIS4622_ID, @COP2510_ID, 'C');
...
VALUES
    ('U000000001','John','Doe',        @MAJOR_BSCS, @TERM_FALL_2025, '2024-08-20','jdoe@usf.edu','813-555-2001'),
    ('U000000002','Jane','Smith',      @MAJOR_BSCS, @TERM_FALL_2025, '2024-08-20','jsmith@usf.edu','813-555-2002'),
    ('U000000003','Alex','Brown',      @MAJOR_BSIT, @TERM_FALL_2025, '2024-08-20','abrown@usf.edu','813-555-2003'),
    ('U000000004','Maria','Lopez',     @MAJOR_BSIT, @TERM_FALL_2025, '2024-08-20','mlopez@usf.edu','813-555-2004'),
    ('U000000005','Luke','Miller',     @MAJOR_BSCP, @TERM_FALL_2025, '2024-08-20','lmiller@usf.edu','813-555-2005'),
    ('U000000006','Sarah','Wilson',    @MAJOR_BSCP, @TERM_FALL_2025, '2024-08-20','swilson@usf.edu','813-555-2006'),
    ('U000000007','Noah','Davis',      @MAJOR_BSCyS,@TERM_FALL_2025, '2024-08-20','ndavis@usf.edu','813-555-2007'),
    ('U000000008','Emma','Taylor',     @MAJOR_BSCyS,@TERM_FALL_2025, '2024-08-20','etaylor@usf.edu','813-555-2008'),
    ('U000000009','Liam','Clark',      @MAJOR_BSCS, @TERM_FALL_2025, '2024-08-20','lclark@usf.edu','813-555-2009'),
    ('U000000010','Olivia','Lewis',    @MAJOR_BSIT, @TERM_FALL_2025, '2024-08-20','olewis@usf.edu','813-555-2010'),
    ('U000000011','Mason','Hall',      @MAJOR_BSCS, @TERM_FALL_2025, '2024-08-20','mhall@usf.edu','813-555-2011'),
    ('U000000012','Ava','Young',       @MAJOR_BSCP, @TERM_FALL_2025, '2024-08-20','ayoung@usf.edu','813-555-2012'),
    ('U000000013','Ethan','King',      @MAJOR_BSCyS,@TERM_FALL_2025, '2024-08-20','eking@usf.edu','813-555-2013'),
    ('U000000014','Sophia','Wright',   @MAJOR_BSIT, @TERM_FALL_2025, '2024-08-20','swright@usf.edu','813-555-2014'),
    ('U000000015','Logan','Scott',     @MAJOR_BSCS, @TERM_FALL_2025, '2024-08-20','lscott@usf.edu','813-555-2015'),
    ('U000000016','Isabella','Green',  @MAJOR_BSCS, @TERM_FALL_2025, '2024-08-20','igreen@usf.edu','813-555-2016'),
    ('U000000017','James','Adams',     @MAJOR_BSIT, @TERM_FALL_2025, '2024-08-20','jadams@usf.edu','813-555-2017'),
    ('U000000018','Mia','Nelson',      @MAJOR_BSCP, @TERM_FALL_2025, '2024-08-20','mnelson@usf.edu','813-555-2018'),
    ('U000000019','Benjamin','Perez',  @MAJOR_BSCyS,@TERM_FALL_2025, '2024-08-20','bperez@usf.edu','813-555-2019'),
    ('U000000020','Charlotte','Moore', @MAJOR_BSCS, @TERM_FALL_2025, '2024-08-20','cmoore@usf.edu','813-555-2020');
...
------------------------------------------------------------
-- StudyPlan: simple 4-year plan snippets
------------------------------------------------------------
INSERT INTO Bellini.StudyPlan (StudentID, TermID, CourseID)
SELECT s.StudentID, @TERM_FALL_2025, @COP2510_ID
FROM Bellini.Student s
WHERE s.USF_ID IN ('U000000001','U000000002');

INSERT INTO Bellini.StudyPlan (StudentID, TermID, CourseID)
SELECT s.StudentID, @TERM_SPRING_2026, @COP3515_ID
FROM Bellini.Student s
WHERE s.USF_ID IN ('U000000001','U000000002');
